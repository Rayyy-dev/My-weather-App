...
import { faSearch, faTint, faWind, faTachometerAlt, faCloud, faSun, faMoon } from '@fortawesome/free-solid-svg-icons';
    ...
    <div className={`weather-dashboard ${theme}`}>
            ...
            <div className="forecast-grid">
              {forecast.slice(0, 5).map((day, index) => (
                <div key={index} className="forecast-item">
                  ...
                  <FontAwesomeIcon icon={day.day.condition.text.toLowerCase().includes('sun') ? faSun : faCloud} className="forecast-icon" />
        ...
        <div className="hourly-forecast">
          {forecast[0].hour.map((hour, index) => (
            <div key={index} className="hourly-item">
              ...
              <FontAwesomeIcon icon={hour.condition.text.toLowerCase().includes('sun') ? faSun : faCloud} className="hourly-icon" />
      ...
      {activeTab === 'tenday' && (
        <div className="tenday-forecast">
          {/* You can add more detailed weather information here */}
        </div>
      )}
