    ...
    <div className="app-container">
      <header className="header">
        ...
        <div className="search-container">
          ...
          <button onClick={() => handleSearch(city)} className="search-button">Search</button>
      ...
      <main>
        ...
        {weather && (
          <div className="weather-content">
            ...
            {activeTab === 'current' && (
              <div className="current-weather fade-in">
                ...
                <div className="weather-main">
                  <img src={weather.current.condition.icon} alt="Weather icon" className="weather-icon pulse" />
            ...
            {activeTab === 'daily' && (
              <div className="daily-forecast fade-in">
